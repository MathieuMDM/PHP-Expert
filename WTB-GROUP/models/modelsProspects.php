...
class ModelProspects
{
    ...
    {
        $this->requete="SELECT * FROM prospect";
        $list = null;
        try {
    ...
    {
        $sql = 'UPDATE prospect SET nom=:parm1, prenom=:parm2, adresse=:parm3, codePostal=:parm4, ville=:parm5, champCommentaire=:parm6 WHERE id=:parm0';
        $this->requete = $this->connection->prepare($sql);
