...
class ViewProspects extends View
{
    ...
    {
        $this->page .= "<h1>Liste des produits sur le stock de la société WTB </h1>";
        
        $tableau = '<div class="container">'
        . '<table class="table table-striped table-bordered" cellspacing="0">'
        . '<thead>'
        . '<th>Date</th><th>Marque</th><th>Modele</th><th>Taille</th><th>Quantité</th><th>Commentaire</th><th>Modification</th><th>Suppression</th><th>Transfert vers SDP</th>'
        . '</thead><tbody>';
    ...
    public function add()
    {
        $this->page .= "<h1>Ajouter un nouveau produit pour la société WTB</h1>";
        $paramaters = array(
            "readonly"=>"",
            "parm0"=>"",
            "parm1"=>"",
    ...
    {
        $this->page .= "<h1>Modifier ce produit WTB</h1>";
        $paramaters = array(
        "readonly"=>"",
    ...
    {
        $this->page .= "<h1>Vous êtes sûr de supprimer ce produit WTB</h1>";
        $paramaters = array(
        "readonly"=>"readonly",
        "parm0"=>$paramGet['parm0'],
        "parm1"=>$paramGet['parm1'],
    ...
    {
        $this->page .= "<h1>Êtes-vous sûr de transférer ce produit WTB vers SDP?</h1>";
        $paramaters = array(
        "readonly"=>"",
        "parm0"=>$paramGet['parm0'],
        "parm1"=>$paramGet['parm1'],
