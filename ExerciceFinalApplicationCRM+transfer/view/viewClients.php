...
class ViewClients extends View
{
    ...
    {
        $this->page .= "<h1>Je suis sur la liste Clients </h1>";
    ...
    public function add()
    {
        $this->page .= "<h1>Vous êtes sur la page d'ajout d'une nouvelle clients</h1>";
        $paramaters = array(
            "readonly"=>"",
            "parm0"=>"",
            "parm1"=>"",
    ...
    {
        $this->page .= "<h1>Je suis sur la page de modif clients</h1>";
        $paramaters = array(
        "readonly"=>"",
    ...
    {
        $this->page .= "<h1>Je suis sur la page de suppression clients</h1>";
        $paramaters = array(
        "readonly"=>"readonly",
        "parm0"=>$paramGet['parm0'],
        "parm1"=>$paramGet['parm1'],
